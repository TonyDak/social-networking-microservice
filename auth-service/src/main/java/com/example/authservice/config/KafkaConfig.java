...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, UserEventDTO> userEventConsumerFactory() {
        ...
        props.put(JsonDeserializer.VALUE_DEFAULT_TYPE, "com.example.authservice.dto.UserEventDTO");
        props.put(JsonDeserializer.TRUSTED_PACKAGES, "*");
        props.put(JsonDeserializer.TYPE_MAPPINGS,
                "com.example.userservice.dto.UserEventDTO:com.example.authservice.dto.UserEventDTO");
